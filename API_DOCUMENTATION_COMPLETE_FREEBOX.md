# Documentation Complète des Endpoints API - Backend Patisry
## URLs Freebox et Local

## Vue d'ensemble

Ce document fournit une documentation exhaustive de tous les endpoints API du système Patisry avec les URLs complètes pour la Freebox et le développement local. Chaque endpoint est documenté avec ses paramètres, réponses, codes d'erreur et tables sources.
